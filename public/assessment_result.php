...
// Fetch attempt details with assessment, course, and enrollment info
$stmt = $pdo->prepare("
    SELECT 
        aa.*,
...
");
$stmt->execute([$u['id'], $attemptId, $u['id']]);
$attempt = $stmt->fetch();
...
// Check if enrollment is archived
if ($attempt['is_archived'] == 1) {
    $retryAllowed = false;
    $retryMessage = 'This course has been archived. No further attempts allowed.';
...
<body>
    ...
    <div class="results-wrapper">
        ...
        <div class="result-card">
            ...
            <!-- Archived Notice (if enrollment is archived) -->
            <?php if ($attempt['is_archived'] == 1): ?>
            <div class="archived-notice">
                <i class="fas fa-archive"></i>
                <div>
                    <p><strong>Course Archived</strong></p>
                    <small>This course has been archived. No further assessment attempts are allowed.</small>
                </div>
            </div>
            <?php endif; ?>

            <!-- Attempts Info -->
            <?php if ($attempt['attempts_allowed'] > 0 && $attempt['is_archived'] != 1): ?>
            ...
            <div class="action-buttons">
                ...
                <?php if($attempt['is_archived'] == 1): ?>
                    <!-- Archived course - no retry button -->
                    <span class="btn-disabled" title="Course has been archived">
                        <i class="fas fa-archive"></i> Course Archived
                    </span>
                <?php elseif($percentageScore == 100): ?>
